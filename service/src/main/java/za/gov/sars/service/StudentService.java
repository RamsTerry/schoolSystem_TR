...
public class StudentService implements StudentServiceLocal {
    ...
    public Student findById(Long id) {
        return studentRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("The requested id [" + id + "] does not exist."));
    }
    ...
    public Student findStudentByStudentNum(String StudentNum) {
        return studentRepository.findStudentByStudentNum(StudentNum);
    }
